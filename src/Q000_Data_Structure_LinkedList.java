public class Q000_Data_Structure_LinkedList {
	private Node head;
	private Node tail;
	private int size;
	...
	/************************   构造函数   *************************/
	public Q000_Data_Structure_LinkedList() {    // 指向数据对象、后继节点的引用都置空
		head = null;
		tail = null;
		size = 0;
	}

	public Q000_Data_Structure_LinkedList(Object e) {   // 指定数据对象及后继节点
		tail = null;
